...
echo -n "L1:" >> $OUT_FILE
python ../rotation_analysis.py -c $CONFIG_FILE -l lens_1 -oa -j | grep "mount_position" >> $OUT_FILE

echo "Processing Lens 2..."
echo -n "L2:" >> $OUT_FILE
python ../rotation_analysis.py -c $CONFIG_FILE -l lens_2 -oa -j | grep "mount_position" >> $OUT_FILE

echo "Processing Lens 3..."
echo -n "L3:" >> $OUT_FILE
python ../rotation_analysis.py -c $CONFIG_FILE -l lens_3 -oa -j | grep "mount_position" >> $OUT_FILE
...
echo -n "L56:" >> $OUT_FILE
python ../rotation_analysis.py -c $CONFIG_FILE -l lens_4a -oa -j | grep "mount_position" >> $OUT_FILE
